...
public struct Cafelogos_Orderlink_PostOrderItemInput {
...
public struct Cafelogos_Orderlink_PostOrderInput {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cafelogos_Orderlink_PostOrderInput.OrderType: CaseIterable {
...
extension Cafelogos_Orderlink_PostOrderItemInput: @unchecked Sendable {}
extension Cafelogos_Orderlink_PostOrderInput: @unchecked Sendable {}
extension Cafelogos_Orderlink_PostOrderInput.OrderType: @unchecked Sendable {}
