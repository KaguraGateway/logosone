...
var file_orderlink_orderlink_service_proto_goTypes = []interface{}{
...
func file_orderlink_orderlink_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_orderlink_orderlink_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orderlink_orderlink_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
