...
public struct Cafelogos_Pos_CoffeeBrew: Sendable {
  ...
  public var brewingTime: UInt32 = 0
...
extension Cafelogos_Pos_CoffeeBrew: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}name\0\u{3}bean_quantity_grams\0\u{1}amount\0\u{3}created_at\0\u{3}updated_at\0\u{3}brewing_time\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.brewingTime) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.brewingTime != 0 {
      try visitor.visitSingularUInt32Field(value: self.brewingTime, fieldNumber: 7)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: Cafelogos_Pos_CoffeeBrew, rhs: Cafelogos_Pos_CoffeeBrew) -> Bool {
    ...
    if lhs.createdAt != rhs.createdAt {return false}
    if lhs.updatedAt != rhs.updatedAt {return false}
    if lhs.brewingTime != rhs.brewingTime {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
