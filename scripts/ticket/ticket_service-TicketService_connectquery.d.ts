...
export const issueTicket: UnaryHooks<RequestIssueTicket, ResponseIssueTicket>;
export const revokeTicket: UnaryHooks<RequestRevokeTicket, ResponseRevokeTicket>;
