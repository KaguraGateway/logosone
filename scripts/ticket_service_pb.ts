...
/**
 * @generated from message cafelogos.RequestIssueTicket
 */
export class RequestIssueTicket extends Message<RequestIssueTicket> {
  ...
  static readonly typeName = "cafelogos.RequestIssueTicket";
...
/**
 * @generated from message cafelogos.ResponseIssueTicket
 */
export class ResponseIssueTicket extends Message<ResponseIssueTicket> {
  /**
   * @generated from field: cafelogos.Ticket ticket = 1;
   */
  ticket?: Ticket;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cafelogos.ResponseIssueTicket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message cafelogos.RequestRevokeTicket
 */
export class RequestRevokeTicket extends Message<RequestRevokeTicket> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cafelogos.RequestRevokeTicket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message cafelogos.ResponseRevokeTicket
 */
export class ResponseRevokeTicket extends Message<ResponseRevokeTicket> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cafelogos.ResponseRevokeTicket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message cafelogos.Ticket
 */
export class Ticket extends Message<Ticket> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "cafelogos.Ticket";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
